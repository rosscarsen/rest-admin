...
class Invoice {
              ...
              child: pw.Column(
                children: [
                  pw.Container(
                    ...
                    child: pw.Text(
                      'INVOICE',
                      style: pw.TextStyle(color: baseColor, fontWeight: pw.FontWeight.bold, fontSize: 40),
                    ),
                  ),
                  pw.Container(
    ...
    return pw.Row(
      ...
      children: [
        pw.Container(
          height: 20,
          width: 100,
          child: pw.BarcodeWidget(barcode: pw.Barcode.pdf417(), data: 'Invoice# $invoiceNumber', drawText: false),
        ),
        pw.Text(
  ...
  pw.PageTheme _buildTheme(PdfPageFormat pageFormat, pw.Font base, pw.Font bold, pw.Font italic) {
    return pw.PageTheme(
      ...
      buildBackground: (context) => pw.FullPage(ignoreMargins: true, child: pw.SvgImage(svg: _bgShape!)),
    );
  }
          ...
          child: pw.Container(
            ...
            child: pw.FittedBox(
              child: pw.Text(
                ...
                style: pw.TextStyle(color: baseColor, fontStyle: pw.FontStyle.italic),
              ),
            ),
          ),
        ),
          ...
          child: pw.Row(
            children: [
              pw.Container(
                ...
                child: pw.Text(
                  'Invoice to:',
                  style: pw.TextStyle(color: _darkColor, fontWeight: pw.FontWeight.bold, fontSize: 12),
                ),
              ),
              pw.Expanded(
                child: pw.Container(
          ...
          child: pw.Column(
            ...
            children: [
              pw.Text(
                ...
                style: pw.TextStyle(color: _darkColor, fontWeight: pw.FontWeight.bold),
              ),
              pw.Container(
                margin: const pw.EdgeInsets.only(top: 20, bottom: 8),
                child: pw.Text(
                  'Payment Info:',
                  style: pw.TextStyle(color: baseColor, fontWeight: pw.FontWeight.bold),
                ),
              ),
              pw.Text(paymentInfo, style: const pw.TextStyle(fontSize: 8, lineSpacing: 5, color: _darkColor)),
            ],
          ),
        ),
        pw.Expanded(
          ...
          child: pw.DefaultTextStyle(
            ...
            child: pw.Column(
              ...
              children: [
                pw.Row(
                  mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                  children: [pw.Text('Sub Total:'), pw.Text(_formatCurrency(_total))],
                ),
                pw.SizedBox(height: 5),
                pw.Row(
                  mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                  children: [pw.Text('Tax:'), pw.Text('${(tax * 100).toStringAsFixed(1)}%')],
                ),
                ...
                pw.DefaultTextStyle(
                  ...
                  child: pw.Row(
                    mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                    children: [pw.Text('Total:'), pw.Text(_formatCurrency(_grandTotal))],
                  ),
                ),
              ],
            ),
          ...
          child: pw.Column(
            ...
            children: [
              pw.Container(
                ...
                child: pw.Text(
                  'Terms & Conditions',
                  style: pw.TextStyle(fontSize: 12, color: baseColor, fontWeight: pw.FontWeight.bold),
                ),
              ),
              pw.Text(
                pw.LoremText().paragraph(40),
                textAlign: pw.TextAlign.justify,
                style: const pw.TextStyle(fontSize: 6, lineSpacing: 2, color: _darkColor),
              ),
            ],
          ),
        ),
  ...
  pw.Widget _contentTable(pw.Context context) {
    ...
    return pw.TableHelper.fromTextArray(
      ...
      headerStyle: pw.TextStyle(color: _baseTextColor, fontSize: 10, fontWeight: pw.FontWeight.bold),
      ...
      data: List<List<String>>.generate(
        products.length,
        (row) => List<String>.generate(tableHeaders.length, (col) => products[row].getIndex(col)),
      ),
    );
  }
}
