...
class OpenDepartmentView extends GetView<OpenDepartmentController> {
  const OpenDepartmentView({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(LocaleKeys.paramSelect.trArgs([LocaleKeys.user.tr])),
        centerTitle: true,
      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          Expanded(
            child: GetX<OpenDepartmentController>(
              init: OpenDepartmentController(),
              builder: (_) {
