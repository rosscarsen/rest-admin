...
import '../modules/master/tables/table_floor_plan/table_floor_plan_binding.dart';
import '../modules/master/tables/table_floor_plan/table_floor_plan_view.dart';
  ...
  static final routes =
      [
        ...
        GetPage(
          ...
          binding: OpenBinding(),
          children: [
            GetPage(name: _Paths.OPEN_PRODUCT, page: () => const OpenProductView(), binding: OpenProductBinding()),
            GetPage(name: _Paths.OPEN_SUPPLIER, page: () => const OpenSupplierView(), binding: OpenSupplierBinding()),
            GetPage(
            ...
            GetPage(name: _Paths.OPEN_SET_MEAL, page: () => const OpenSetMealView(), binding: OpenSetMealBinding()),
            GetPage(name: _Paths.OPEN_CUSTOMER, page: () => const OpenCustomerView(), binding: OpenCustomerBinding()),
            GetPage(name: _Paths.OPEN_USER, page: () => const OpenUserView(), binding: OpenUserBinding()),
            GetPage(
        ...
        GetPage(name: _Paths.PDF, page: () => const PdfView(), binding: PdfBinding()),
        GetPage(
          name: _Paths.MASTER,
          ...
          children: [
            ...
            GetPage(
              ...
              children: [
                GetPage(name: _Paths.STOCK_EDIT, page: () => const StockEditView(), binding: StockEditBinding()),
              ],
            ),
            GetPage(
            ...
            GetPage(
              ...
              children: [GetPage(name: _Paths.UNIT_EDIT, page: () => const UnitEditView(), binding: UnitEditBinding())],
            ),
            GetPage(
              ...
              children: [
                GetPage(name: _Paths.SET_MENU_EDIT, page: () => const SetMenuEditView(), binding: SetMenuEditBinding()),
              ],
            ),
            GetPage(
            ...
            GetPage(name: _Paths.PRINTER, page: () => const PrinterView(), binding: PrinterBinding()),
            GetPage(name: _Paths.TIME_SALES, page: () => const TimeSalesView(), binding: TimeSalesBinding()),
            GetPage(
            ...
            GetPage(
              ...
              children: [
                GetPage(name: _Paths.TABLE_EDIT, page: () => const TableEditView(), binding: TableEditBinding()),
                GetPage(
                  name: _Paths.TABLE_FLOOR_PLAN,
                  page: () => const TableFloorPlanView(),
                  binding: TableFloorPlanBinding(),
                ),
              ],
            ),
            GetPage(
        ...
        if (page.name != _Paths.SIGNIN && page.name != _Paths.PAGE_NOT_FOUND) {
          return page.copyWith(middlewares: [AuthMiddleware()]);
        }
        return page;
      }).toList();
}
