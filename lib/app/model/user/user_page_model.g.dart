...
UserPageModel _$UserPageModelFromJson(Map<String, dynamic> json) =>
    UserPageModel(
      ...
      apiResult: json['apiResult'] == null
          ? null
          : UserPageResult.fromJson(json['apiResult'] as Map<String, dynamic>),
    );
...
UserPageResult _$UserPageResultFromJson(Map<String, dynamic> json) =>
    UserPageResult(
...
Map<String, dynamic> _$UserPageResultToJson(UserPageResult instance) =>
    <String, dynamic>{
