...
CustomerEditModel _$CustomerEditModelFromJson(Map<String, dynamic> json) => CustomerEditModel(
  status: (json['status'] as num?)?.toInt(),
  msg: json['msg'] as String?,
  apiResult: json['apiResult'] == null ? null : CustomerEditResult.fromJson(json['apiResult'] as Map<String, dynamic>),
);

Map<String, dynamic> _$CustomerEditModelToJson(CustomerEditModel instance) => <String, dynamic>{
  'status': instance.status,
  'msg': instance.msg,
  'apiResult': instance.apiResult?.toJson(),
};

CustomerEditResult _$ApiResultFromJson(Map<String, dynamic> json) => CustomerEditResult(
  customerInfo: json['customerInfo'] == null
      ? null
      : CustomerData.fromJson(json['customerInfo'] as Map<String, dynamic>),
  customerType: (json['customerType'] as List<dynamic>?)?.map((e) => e as String).toList(),
  ...
  currency: (json['currency'] as List<dynamic>?)?.map((e) => CurrencyData.fromJson(e as Map<String, dynamic>)).toList(),
  customerDiscount: (json['customerDiscount'] as List<dynamic>?)
      ?.map((e) => CustomerDiscount.fromJson(e as Map<String, dynamic>))
      .toList(),
);

Map<String, dynamic> _$ApiResultToJson(CustomerEditResult instance) => <String, dynamic>{
  ...
  'customerDiscount': instance.customerDiscount?.map((e) => e.toJson()).toList(),
};

CustomerDiscount _$CustomerDiscountFromJson(Map<String, dynamic> json) => CustomerDiscount(
...
Map<String, dynamic> _$CustomerDiscountToJson(CustomerDiscount instance) => <String, dynamic>{
