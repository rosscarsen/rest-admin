...
CustomerEditResult _$CustomerEditResultFromJson(Map<String, dynamic> json) =>
    CustomerEditResult(
...
Map<String, dynamic> _$CustomerEditResultToJson(
  CustomerEditResult instance,
) => <String, dynamic>{
